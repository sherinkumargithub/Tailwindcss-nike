    ...
    <footer className='max-container'>
      <div className="flex justify-between items-start flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          {/* here the new sections is about the product , help and the contacts */}
        <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap">
            {footerLinks.map((section)=>(
              <div key={section}>
                <h4 className='text-white max-lg:mt-14 font-montserrat text-2xl leading-normal font-medium mb-6'>
                  {section.title}
                </h4>
